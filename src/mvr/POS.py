...
# initialization method
    def __init__(self):
        ...
        self.sp.type_mask = int('00000111', 2)
        # LOCAL_NED
        self.sp.orientation.x = 0
        self.sp.orientation.y = 0
        self.sp.orientation.z = 0
...
# initiate node
    ...
    rospy.Subscriber('test/baseline', Float32, cnt.baseCb) 
    # Subscribe to drone state
    rospy.Subscriber('mavros/state', State, cnt.stateCb)

    # Subscribe to drone's local position
    rospy.Subscriber('mocap_node/local_position/pose', PoseStamped, cnt.posCb)
